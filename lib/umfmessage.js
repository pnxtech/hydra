...
class UMFMessage {
  ...
  */
  validate() {
    return this.message.from != null && this.message.from.trim() != "" && this.message.to != null && this.message.to.trim() != "" && this.message.body != null
  }
}
...
function createMessageInstance(message) {
  ...
  if (isNotEmptyString(message.from ?? message.frm)) {
    proxy.from = message.from ?? message.frm;
  }
  if ((message.headers ?? message.hdr) != null) {
  ...
  if (isNotEmptyString(message.forward ?? message.fwd)) {
    proxy.forward = message.forward ?? message.fwd;
  }
  if ((message.body ?? message.bdy) != null) {
    proxy.body = message.body ?? message.bdy;
  }
  if (isNotEmptyString(message.authorization ?? message.aut)) {
